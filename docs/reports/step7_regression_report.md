# Step 7 — Regression (Step 6 physics setup, slab-pull disabled)

> **Step 7 regression run for milestone "Solver reconstruction".**
> Setup: identical to Step 6 physics — same Voronoi tessellation, same dynamic detection, same Closed-mode recycling, same rates — with **`SlabPullConfig::Disabled`**. The slab pipeline is structurally bypassed (no `Q_sub_conv`, no ODE, no `n̂`, no `SlabPullForce`, no `m̃` advection).
> Target: wallclock and CG-iters ratios within `[0.95, 1.05]` of Step 6 physics; scalar parity on `mass_conservation_residual` at machine noise.
...
- wallclock total: `33.688 s`
- wallclock per step (mean): `112.293 ms`
- steps: `300`
...
|---|---|---|---|---|
| `docs/reports/step7_regression_heightmaps/s_64x64_t0000.png` | `1.601e-1` | `1.198e0` | `5.571e-1` | `docs/reports/step7_regression_heightmaps/s_64x64_t0000_colorbar.png` |
| `docs/reports/step7_regression_heightmaps/s_64x64_t0150.png` | `1.599e-1` | `1.197e0` | `5.570e-1` | `docs/reports/step7_regression_heightmaps/s_64x64_t0150_colorbar.png` |
| `docs/reports/step7_regression_heightmaps/s_64x64_t0300.png` | `1.597e-1` | `1.196e0` | `5.569e-1` | `docs/reports/step7_regression_heightmaps/s_64x64_t0300_colorbar.png` |

### Numerical regression vs Step 6 physics

Same forcing, same preset, same yielding (Enabled, Bi=0.15), same basal drag (Enabled, Br=0.05), same Voronoi tessellation (num_plates=8, seed=42), same Closed-mode recycling as Step 6 physics — with **`SlabPullConfig::Disabled`**. The slab pipeline is structurally bypassed (no `Q_sub_conv`, no ODE, no `n̂`, no force, no `m̃` advection). Ratio targets: wallclock and CG-iter-per-linear-solve both within `[0.95, 1.05]` vs Step 6 physics (`34.402s / 312.293s`, `129.6 / 240.4` CG mean at 64² / 128²).

#### Grid 64×64 — comparison vs Step 6 physics

| metric | previous | current | ratio / note |
|---|---|---|---|
| wallclock (s) | 34.402 | 33.688 | ×0.98 |
...
- wallclock total: `319.315 s`
- wallclock per step (mean): `1064.384 ms`
- steps: `300`
...
| snapshot | min | max | mean | colour-bar |
|---|---|---|---|---|
| `docs/reports/step7_regression_heightmaps/s_128x128_t0000.png` | `1.600e-1` | `1.198e0` | `5.569e-1` | `docs/reports/step7_regression_heightmaps/s_128x128_t0000_colorbar.png` |
| `docs/reports/step7_regression_heightmaps/s_128x128_t0150.png` | `1.598e-1` | `1.197e0` | `5.568e-1` | `docs/reports/step7_regression_heightmaps/s_128x128_t0150_colorbar.png` |
| `docs/reports/step7_regression_heightmaps/s_128x128_t0300.png` | `1.597e-1` | `1.197e0` | `5.567e-1` | `docs/reports/step7_regression_heightmaps/s_128x128_t0300_colorbar.png` |
...
| metric | previous | current | ratio / note |
|---|---|---|---|
| wallclock (s) | 312.293 | 319.315 | ×1.02 |
