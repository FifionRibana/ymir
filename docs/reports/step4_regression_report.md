# Step 4 — Sinusoidal forcing, basal drag disabled (regression mirror of Step 3)

> **Step 4 regression run for milestone "Solver reconstruction".**
> Same setup as Step 3 regression (SinusoidalForce ε=10, `YieldingConfig::Disabled`) with the new flag `BasalDragConfig::Disabled`. The `Disabled` variant **structurally bypasses** the drag contribution in `apply_momentum` and `momentum_diagonal` (`Option<&Field2D>` short-circuits before any face loop). Target: wallclock ratio and CG-iters ratio vs Step 3 both within `[0.95, 1.05]`.
...
| basal drag | `Disabled` (structural bypass) | ✅ |
...
- wallclock total: `0.400 s`
- wallclock per step (mean): `1.332 ms`
- steps: `300`
...
|---|---|---|---|---|
| `docs/reports/step4_regression_heightmaps/s_64x64_t0000.png` | `9.800e-1` | `1.020e0` | `1.000e0` | `docs/reports/step4_regression_heightmaps/s_64x64_t0000_colorbar.png` |
| `docs/reports/step4_regression_heightmaps/s_64x64_t0150.png` | `4.651e-1` | `2.113e0` | `1.000e0` | `docs/reports/step4_regression_heightmaps/s_64x64_t0150_colorbar.png` |
| `docs/reports/step4_regression_heightmaps/s_64x64_t0300.png` | `2.166e-1` | `4.164e0` | `1.000e0` | `docs/reports/step4_regression_heightmaps/s_64x64_t0300_colorbar.png` |

### Numerical regression vs Step 3

Same forcing, same preset, same setup as Step 3, with `BasalDragConfig::Disabled` and `YieldingConfig::Disabled`. Ratio targets: wallclock and CG-iter-per-linear-solve both within `[0.95, 1.05]` — the structural by-pass of the drag contribution must be zero-cost.

#### Grid 64×64 — comparison vs Step 1

| metric | previous | current | ratio / note |
|---|---|---|---|
| wallclock (s) | 0.406 | 0.400 | ×0.98 |
| CG iters / linear solve (mean) | 22.8 | 22.8 | ×1.00 [idéal] |
| S mass drift (relative) | 2.331e-15 | 2.331e-15 | gate 1e-10 |
...
- wallclock total: `2.344 s`
- wallclock per step (mean): `7.814 ms`
- steps: `300`
...
| snapshot | min | max | mean | colour-bar |
|---|---|---|---|---|
| `docs/reports/step4_regression_heightmaps/s_128x128_t0000.png` | `9.800e-1` | `1.020e0` | `1.000e0` | `docs/reports/step4_regression_heightmaps/s_128x128_t0000_colorbar.png` |
| `docs/reports/step4_regression_heightmaps/s_128x128_t0150.png` | `4.647e-1` | `2.136e0` | `1.000e0` | `docs/reports/step4_regression_heightmaps/s_128x128_t0150_colorbar.png` |
| `docs/reports/step4_regression_heightmaps/s_128x128_t0300.png` | `2.161e-1` | `4.445e0` | `1.000e0` | `docs/reports/step4_regression_heightmaps/s_128x128_t0300_colorbar.png` |
...
| metric | previous | current | ratio / note |
|---|---|---|---|
| wallclock (s) | 2.304 | 2.344 | ×1.02 |
| CG iters / linear solve (mean) | 48.2 | 48.2 | ×1.00 [idéal] |
| S mass drift (relative) | -5.551e-16 | -5.551e-16 | gate 1e-10 |
