# Step 2 — Sinusoidal forcing (regression mirror of Step 1)

> **Step 2 regression run for milestone "Solver reconstruction".**
> Mirror of the Step 1 baseline (same preset, CFL, tolerances, initial S, timesteps, seed) with SinusoidalForce ε=10. Purpose: isolate **solver-induced** drift from the Step-2 physics changes (the `forcing/` module refactor, Box-dyn dispatch, etc.).
> Target: wallclock ratio and CG-iters ratio vs Step 1 both within `[0.9, 1.1]`.
...
|---|---|---|---|---|
| `docs/reports/step2_regression_heightmaps/s_64x64_t0000.png` | `9.800e-1` | `1.020e0` | `1.000e0` | `docs/reports/step2_regression_heightmaps/s_64x64_t0000_colorbar.png` |
| `docs/reports/step2_regression_heightmaps/s_64x64_t0150.png` | `4.651e-1` | `2.113e0` | `1.000e0` | `docs/reports/step2_regression_heightmaps/s_64x64_t0150_colorbar.png` |
| `docs/reports/step2_regression_heightmaps/s_64x64_t0300.png` | `2.166e-1` | `4.164e0` | `1.000e0` | `docs/reports/step2_regression_heightmaps/s_64x64_t0300_colorbar.png` |

### Numerical regression vs Step 1

Same forcing, same preset, same setup as Step 1. Ratio targets: wallclock and CG-iter-per-linear-solve both within `[0.9, 1.1]`.
...
| snapshot | min | max | mean | colour-bar |
|---|---|---|---|---|
| `docs/reports/step2_regression_heightmaps/s_128x128_t0000.png` | `9.800e-1` | `1.020e0` | `1.000e0` | `docs/reports/step2_regression_heightmaps/s_128x128_t0000_colorbar.png` |
| `docs/reports/step2_regression_heightmaps/s_128x128_t0150.png` | `4.647e-1` | `2.136e0` | `1.000e0` | `docs/reports/step2_regression_heightmaps/s_128x128_t0150_colorbar.png` |
| `docs/reports/step2_regression_heightmaps/s_128x128_t0300.png` | `2.161e-1` | `4.445e0` | `1.000e0` | `docs/reports/step2_regression_heightmaps/s_128x128_t0300_colorbar.png` |
